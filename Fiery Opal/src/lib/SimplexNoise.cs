...
namespace Simplex
{
    ...
    public class Noise
    {
        ...
        public static float[,] Calc2D(int x, int y, int width, int height, float scale)
        {
            float[,] values = new float[width, height];
            for (int i = 0; i < width; i++)
                for (int j = 0; j < height; j++)
        ...
        public static float[,,] Calc3D(int x, int y, int z, int width, int height, int length, float scale)
        {
